...
// focus
#define COLORPICKER_FOCUS_RGAREA   1
#define COLORPICKER_FOCUS_BAREA    2
#define COLORPICKER_FOCUS_RVALAREA 3
#define COLORPICKER_FOCUS_GVALAREA 4
#define COLORPICKER_FOCUS_BVALAREA 5
#define COLORPICKER_FOCUS_DEFAULT  COLORPICKER_FOCUS_RGAREA
