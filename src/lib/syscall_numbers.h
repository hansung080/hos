...
#define SYSCALL_CHANGETASKAFFINITY 303
#define SYSCALL_ENDTASK            304
#define SYSCALL_EXIT               305
#define SYSCALL_GETTASKCOUNT       306
#define SYSCALL_EXISTTASK          307
#define SYSCALL_GETPROCESSORLOAD   308
