...
int main(const char* args) {
	...
	windowId = createWindow(x, y, width, height, WINDOW_FLAGS_DEFAULT | WINDOW_FLAGS_RESIZABLE | WINDOW_FLAGS_BLOCKING, "Text Viewer", WINDOW_COLOR_BACKGROUND, null, WINDOW_INVALIDID);
